...
const CreateBlog = forwardRef(
  ({ setBlogs, eventHappened, errorHappened }, ref) => {
    ...
    return (
      <form
        ...
        id="create-blog"
        className={`px-4 sm:px-8 py-6 rounded-md bg-orange-50 dark:bg-stone-600 shadow-xl dark:shadow-stone-900 flex mx-6 sm:mx-auto flex-1 flex-col items-stretch max-w-xl mt-16 -mb-8 ${
          !visible ? "hidden" : "relative"
        }`}
      >
        ...
        <div className="input-grid">
          <label htmlFor="title">
            <p className="dark:text-orange-50 my-1 text-neutral-600">title</p>
          </label>
        ...
        <div>
          <label htmlFor="url">
            <p className="dark:text-orange-50 my-1 text-neutral-600">url</p>
          </label>
          <div className="relative">
            <input
              className="px-2 dark:bg-neutral-600 dark:border dark:border-stone-500 w-full block border border-stone-300  dark:shadow-lg p-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 focus-visible:ring-offset-0 dark:focus-visible:ring-orange-300 dark:text-orange-50 focus-visible:transition focus-visible:duration-300 ease-in-out"
        ...
        <button
          type="button"
          className="absolute top-0 right-0 p-3 hover:opacity-50 transition duration-150 dark:text-orange-100"
