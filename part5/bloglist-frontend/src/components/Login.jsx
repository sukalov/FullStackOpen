const Login = ({ user, username, setUsername, password, setPassword, handleLogin }) => {
    ...
    <div className="flex h-screen items-center p-2">
        <form onSubmit={handleLogin} className="px-8 py-6 rounded-md bg-orange-50 dark:bg-stone-600 shadow-md flex mx-auto flex-1 flex-col items-stretch max-w-sm">
            <div className="input-grid">
                <p className="dark:text-orange-50 my-1">username</p>
            ...
            <div>
                <p className="dark:text-orange-50 mt-2 mb-1">password</p>
                <input
